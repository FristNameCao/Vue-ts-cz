  ...
  <div class="content">
    ...
    <div class="users-list">
      ...
      >
        ...
        <el-table-column prop="realname" label="真实姓名" width="140px" />
        <el-table-column prop="cellphone" label="手机号码" width="180px" />
...
function fetchUserListData(formData: any = {}) {
  ...
  console.log('queryInfo1', queryInfo, formData)
  // 2.发起网络请求
...
function handleDeleClick(id: number) {
  systemStore.deleUserByIdAction(id)
}
// 6.新建用户操作
